...
public class PriceLine<T> {
  ...
  public void clear(){
    this.points.clear();// remove all elements，set自帶method
  }
  ...
  public static void main(String[] args) {
    PriceLine<Candle> candleList = new PriceLine<>(LineType.MIN5, "0700.HK", 1L);

    candleList.add(new PricePoint<Candle>//
    (LocalDateTime.of(LocalDate.of(2024, 11, 29), LocalTime.now()),
    new Candle(456.87,456.87,456.87,456.87))
    );
